    ...
    public partial class Form1 : Form
    {
        ...
        private void Tile1_Click(object sender, EventArgs e)
        {
            if (Tile1.Text == "")
            {
                ...
                else if (Tile1.Text == Tile2.Text)
                {
                    ...
                    {
                        MessageBox.Show("Player " + Tile3.Text + " is the Winner");
                        Tile1.Text = "";
                        Tile2.Text = "";
                        Tile3.Text = "";
                        Tile4.Text = "";
                ...
                else if (Tile1.Text == Tile6.Text)
                {
                    if (Tile6.Text == Tile9.Text)
                    {
                        MessageBox.Show("Player " + Tile1.Text + " is the Winner");
                        Tile1.Text = "";
                        Tile2.Text = "";
        ...
        private void Tile2_Click(object sender, EventArgs e)
        {
            if (Tile2.Text == "")
            {
                ...
                else if (Tile2.Text == Tile5.Text)
                {
                    if (Tile5.Text == Tile8.Text)
                    {
                        MessageBox.Show("Player " + Tile2.Text + " is the Winner");
                        Tile1.Text = "";
                        Tile2.Text = "";
                        Tile3.Text = "";
                        Tile4.Text = "";
        ...
        private void Tile3_Click(object sender, EventArgs e)
        {
            if (Tile3.Text == "")
            {
                ...
                else if (Tile3.Text == Tile4.Text)
                {
                    if (Tile4.Text == Tile7.Text)
                    {
                        MessageBox.Show("Player " + Tile3.Text + " is the Winner");
                        Tile1.Text = "";
                        Tile2.Text = "";
        ...
        private void Tile4_Click(object sender, EventArgs e)
        {
            if (Tile4.Text == "")
            {
                ...
                else if (Tile4.Text == Tile7.Text)
                {
                    if (Tile7.Text == Tile3.Text)
                    {
                        MessageBox.Show("Player " + Tile3.Text + " is the Winner");
                        Tile1.Text = "";
                        Tile2.Text = "";
        ...
        private void Tile5_Click(object sender, EventArgs e)
        {
            if (Tile5.Text == "")
            {
                ...
                else if (Tile5.Text == Tile8.Text)
                {
                    if (Tile8.Text == Tile2.Text)
                    {
                        MessageBox.Show("Player " + Tile2.Text + " is the Winner");
                        Tile1.Text = "";
                        Tile2.Text = "";
        ...
        private void Tile6_Click(object sender, EventArgs e)
        {
            if (Tile6.Text == "")
            {
                ...
                else if (Tile6.Text == Tile9.Text)
                {
                    if (Tile9.Text == Tile1.Text)
                    {
                        MessageBox.Show("Player " + Tile1.Text + " is the Winner");
                        Tile1.Text = "";
                        Tile2.Text = "";
        ...
        private void Tile7_Click(object sender, EventArgs e)
        {
            if (Tile7.Text == "")
            {
                ...
                else if (Tile7.Text == Tile8.Text)
                {
                    if (Tile8.Text == Tile9.Text)
                    {
                        MessageBox.Show("Player " + Tile9.Text + " is the Winner");
                        Tile1.Text = "";
                        Tile2.Text = "";
                ...
                else if (Tile7.Text == Tile4.Text)
                {
                    if (Tile4.Text == Tile3.Text)
                    {
                        MessageBox.Show("Player " + Tile3.Text + " is the Winner");
                        Tile1.Text = "";
                        Tile2.Text = "";
        ...
        private void Tile8_Click(object sender, EventArgs e)
        {
            if (Tile8.Text == "")
            {
                ...
                if (Tile8.Text == Tile7.Text)
                {
                    if (Tile7.Text == Tile9.Text)
                    {
                        MessageBox.Show("Player " + Tile9.Text + " is the Winner");
                        Tile1.Text = "";
                        Tile2.Text = "";
                ...
                else if (Tile8.Text == Tile5.Text)
                {
                    if (Tile5.Text == Tile2.Text)
                    {
                        MessageBox.Show("Player " + Tile2.Text + " is the Winner");
                        Tile1.Text = "";
                        Tile2.Text = "";
        ...
        private void Tile9_Click(object sender, EventArgs e)
        {
            if (Tile9.Text == "")
            {
                ...
                else if (Tile9.Text == Tile6.Text)
                {
                    if (Tile6.Text == Tile1.Text)
                    {
                        MessageBox.Show("Player " + Tile1.Text + " is the Winner");
                        Tile1.Text = "";
                        Tile2.Text = "";
